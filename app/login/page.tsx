    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans antialiased text-gray-900">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <p className="mt-1.5 text-sm text-gray-500">
          New to Asklo?{" "}
          <a href="/signup" className="font-semibold text-blue-600 hover:text-blue-700 hover:underline transition">
            Create an account
          </a>
        </p>
      </div>
        ...
        <div className="bg-white py-8 px-4 border border-gray-200/80 shadow-sm sm:rounded-2xl sm:px-10">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-3 text-gray-400 font-semibold tracking-wider">Or email login</span>
            </div>
          </div>
